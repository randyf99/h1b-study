...
const Preloader = () =>
  <div className="App container">
    <h1>The average H1B in tech pays $85,164/year</h1>
    <p className="lead">
      Since 2012 the US tech industry has sponsored 176,075 H1B work visas. Most of them paid <b>$60,660 to $111,668</b>{' '}
